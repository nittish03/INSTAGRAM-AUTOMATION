...
urlpatterns = [
    ...
    path("api/daemon/logs/", views.api_daemon_logs, name="api_daemon_logs"),
    ...
    path("api/messages/drafts/<int:draft_id>/regenerate/", views.api_message_draft_regenerate, name="api_message_draft_regenerate"),
    ...
    path("api/instagram-profiles/", views.api_instagram_profiles, name="api_instagram_profiles"),
    path(
        "api/instagram-profiles/<int:profile_id>/",
        views.api_instagram_profile_delete,
        name="api_instagram_profile_delete",
    ),
    path(
        "api/instagram-profiles/<int:profile_id>/toggle/",
        views.api_instagram_profile_toggle,
        name="api_instagram_profile_toggle",
    ),
    ...
    path("api/site-config/list-models/", views.api_site_config_list_models, name="api_site_config_list_models"),
    path("api/site-config/llm-chat/", views.api_site_config_llm_chat, name="api_site_config_llm_chat"),
