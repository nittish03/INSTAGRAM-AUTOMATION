...
class LinkedInProfile(models.Model):
    ...
    connect_daily_limit = models.PositiveIntegerField(default=3)
    connect_weekly_limit = models.PositiveIntegerField(default=12)
    follow_up_daily_limit = models.PositiveIntegerField(default=8)
